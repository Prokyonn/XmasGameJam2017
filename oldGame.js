...
var state = {
    preload: function () {
        ...
        this.load.image("bullet", BASE_PATH + "assets/bullet.png?" + ASSET_VERSION, 5, 9);
    },
    create: function () {
        ...
        this.weapon.trackSprite(this.player, 50, 15, true);
        ...
        this.chimneys = this.add.group();
            // this.text = this.add.text(100, 100, "asdasdsadasdsadsadds", {
            //     fill: '#ffdd00',
            //     align: 'center'
            // });
    ...
    update: function () {
        ...
        if (!this.gameOver) {
            ...
            this.game.physics.arcade.overlap(this.weapon.bullets, this.chimneys, this.attackChimney, null, this);
            ...
            this.background3.tilePosition.x -= this.time.physicsElapsed * SPEED;
            if (!this.player.body.touching.down)
    ...
    killByChimney: function (player, chimney) {
        ...
        this.showHint(player, 'Ouuuuchhh');
        this.setGameOver();
    },
    attackChimney: function (bullet, chimney) {
        chimney.hp -= 1;
        bullet.kill();
        this.showHint(this.player, 'Hit');
        if (chimney.hp == 0) {
            chimney.kill();
            this.spawnChimney();
        }
    ...
    createWeapon: function(){
        ...
        this.weapon = game.add.weapon(500, 'bullet');
